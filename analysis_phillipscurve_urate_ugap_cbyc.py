...
for country, country_nice in tqdm(zip(list_countries_keep, list_countries_keep_nice)):
    ...
    file_name = path_output + "phillipscurve_urate_ugap_params_ols" + "_" + country
    ...
    file_name = path_output + "phillipscurve_urate_ugap_params_ols_reer" + "_" + country
    list_file_names += [file_name]
...
# no reer
file_name = path_output + "phillipscurve_urate_ugap_cbyc_params_ols"
list_file_names += [file_name]
fig = heatmap(
...
file_name = path_output + "phillipscurve_urate_ugap_cbyc_params_ols_sigonly"
list_file_names += [file_name]
fig = heatmap(
...
# telsendimg(conf=tel_config, path=file_name + ".png", cap=chart_title)
# reer
file_name = path_output + "phillipscurve_urate_ugap_cbyc_params_ols_reer"
list_file_names += [file_name]
fig = heatmap(
...
file_name = path_output + "phillipscurve_urate_ugap_cbyc_params_ols_sigonly_reer"
list_file_names += [file_name]
fig = heatmap(
...
file_name_pdf = path_output + "phillipscurve_urate_ugap_cbyc_params"
...
telsendmsg(
    conf=tel_config,
    msg="global-plucking --- analysis_phillipscurve_urate_ugap_cbyc: COMPLETED",
)
