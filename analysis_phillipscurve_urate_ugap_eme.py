...
file_name = path_output + "phillipscurve_urate_ugap_eme_params_pols"
...
file_name = path_output + "phillipscurve_urate_ugap_eme_params_pols_reer"
list_file_names += [file_name]
...
file_name = path_output + "phillipscurve_urate_ugap_eme_params_fe"
list_file_names += [file_name]
...
file_name = path_output + "phillipscurve_urate_ugap_eme_params_fe_reer"
list_file_names += [file_name]
...
try:
    ...
    file_name = path_output + "phillipscurve_urate_ugap_eme_params_gmmiv"
    list_file_names += [file_name]
    ...
    file_name = path_output + "phillipscurve_urate_ugap_eme_params_gmmiv_reer"
    list_file_names += [file_name]
...
file_name = path_output + "phillipscurve_urate_ugap_eme_params_twfe"
list_file_names += [file_name]
...
file_name = path_output + "phillipscurve_urate_ugap_eme_params_twfe_reer"
list_file_names += [file_name]
...
file_name = path_output + "phillipscurve_urate_ugap_eme_params_re"
list_file_names += [file_name]
...
file_name = path_output + "phillipscurve_urate_ugap_eme_params_re_reer"
list_file_names += [file_name]
...
file_name_pdf = path_output + "phillipscurve_urate_ugap_eme_params"
...
# X --- Notify
telsendmsg(
    conf=tel_config, msg="global-plucking --- analysis_phillipscurve_urate_ugap_eme: COMPLETED"
)
