...
file_name = path_output + "macrodynamics_rgdp_fd_threshold_lp_irf_ae"
...
fig_irf = lp.ThresholdIRFPlot(
    ...
    maintitle="Local Projections Model: Impulse Response Functions (Advanced Economies); Red = U-Rate is At its Floor",
    show_fig=False,
    save_pic=False,
    out_path="",
    out_name="",
...
# X --- Notify
telsendmsg(
    conf=tel_config, msg="global-plucking --- analysis_macrodynamics_rgdp_fd_threshold_ae: COMPLETED"
)
