...
file_name = path_output + "macrodynamics_rgdp_threshold_lp_irf_reducedsample"
...
fig_irf = lp.ThresholdIRFPlot(
    ...
    maintitle="Local projections model: impulse response functions (excluding IND, BRA and MYS); red = u-rate is at the floor",
    show_fig=False,
    save_pic=False,
    out_path="",
    out_name="",
...
# X --- Notify
telsendmsg(
    conf=tel_config, msg="global-plucking --- analysis_macrodynamics_rgdp_threshold_reducedsample: COMPLETED"
)
