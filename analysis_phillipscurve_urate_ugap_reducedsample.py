...
file_name = path_output + "phillipscurve_urate_ugap_reducedsample_params_pols"
list_file_names += [file_name]
chart_title = "Pooled OLS: Without REER (Excluding MYS, IND, BRA)"
fig = heatmap(
...
file_name = path_output + "phillipscurve_urate_ugap_reducedsample_params_pols_reer"
list_file_names += [file_name]
chart_title = "Pooled OLS: With REER (Excluding MYS, IND, BRA)"
fig = heatmap(
...
file_name = path_output + "phillipscurve_urate_ugap_reducedsample_params_fe"
list_file_names += [file_name]
chart_title = "FE: Without REER (Excluding MYS, IND, BRA)"
fig = heatmap(
...
file_name = path_output + "phillipscurve_urate_ugap_reducedsample_params_fe_reer"
list_file_names += [file_name]
chart_title = "FE: With REER (Excluding MYS, IND, BRA)"
fig = heatmap(
...
file_name = path_output + "phillipscurve_urate_ugap_reducedsample_params_gmmiv"
list_file_names += [file_name]
chart_title = "GMM-IV: Without REER (Excluding MYS, IND, BRA)"
fig = heatmap(
...
file_name = path_output + "phillipscurve_urate_ugap_reducedsample_params_gmmiv_reer"
list_file_names += [file_name]
chart_title = "GMM-IV: With REER (Excluding MYS, IND, BRA)"
fig = heatmap(
...
file_name = path_output + "phillipscurve_urate_ugap_reducedsample_params_twfe"
list_file_names += [file_name]
chart_title = "TWFE: Without REER (Excluding MYS, IND, BRA)"
fig = heatmap(
...
file_name = path_output + "phillipscurve_urate_ugap_reducedsample_params_twfe_reer"
list_file_names += [file_name]
chart_title = "TWFE: With REER (Excluding MYS, IND, BRA)"
fig = heatmap(
...
file_name = path_output + "phillipscurve_urate_ugap_reducedsample_params_re"
list_file_names += [file_name]
chart_title = "RE: Without REER (Excluding MYS, IND, BRA)"
fig = heatmap(
...
file_name = path_output + "phillipscurve_urate_ugap_reducedsample_params_re_reer"
list_file_names += [file_name]
chart_title = "RE: With REER (Excluding MYS, IND, BRA)"
fig = heatmap(
...
list_file_names += [file_name]
chart_title = "AICs and Log-Likelihood of Estimated Models (Excluding MYS, IND, BRA)"
fig = heatmap(
    input=df_loglik,
    mask=False,
    colourmap="vlag",
...
# X --- Notify
telsendmsg(
    conf=tel_config, msg="global-plucking --- analysis_phillipscurve_urate_ugap_reducedsample: COMPLETED"
)
