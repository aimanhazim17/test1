...
df_params = pd.read_parquet(
    path_output + "phillipscurve_urate_ugap_exusa_params_fe_reer" + ".parquet"
)
dict_math_greek = {
    r"$u_{t}$": "urate",
    r"$u_{t}^{usa}$": "urate_usa",
    r"$u^{gap}_{t}$": "urate_gap",
    r"$u^{gap, USA}_{t}$": "urate_gap_usa",
    r"$u_{t} * u^{gap}_{t}$": "urate:urate_gap",
    r"$u_{t}^{USA} * u^{gap, USA}_{t}$": "urate_usa:urate_gap_usa",
    r"$u_{t} * u^{gap}_{t}$": "urate_int_urate_gap",
    r"$u_{t}^{USA} * u^{gap, USA}_{t}$": "urate_int_urate_gap_usa",
...
for country_groups, snakecase_group_name, nice_group_name, n_rows, n_cols in tqdm(
    ...
    file_name = (
        path_output + "phillipscurve_slope_urate_ugap_exusa" + "_" + snakecase_group_name
    )
    ...
    file_name = (
        path_output + "phillipscurve_slope_flattening_urate_ugap_exusa" + "_" + snakecase_group_name
    )
    fig.write_image(file_name + ".png")
    # telsendimg(
    #     conf=tel_config,
    ...
    # )
    list_file_names += [file_name]
pdf_file_name = path_output + "phillipscurve_slope_urate_ugap_exusa"
...
telsendmsg(
    conf=tel_config,
    msg="global-plucking --- analysis_phillipscurve_slope_urate_ugap_exusa: COMPLETED",
)
