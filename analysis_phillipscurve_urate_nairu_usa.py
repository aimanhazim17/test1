...
# POLS
# Without REER
eqn = "corecpi ~ 1 + urate * nairu_gap + expcpi + corecpi_lag1"
...
# With REER
eqn = "corecpi ~ 1 + urate * nairu_gap + expcpi + corecpi_lag1 + reer"
(
    mod_pols_reer,
    res_pols_reer,
...
file_name_pdf = path_output + "phillipscurve_urate_nairu_usa_params"
...
telsendmsg(
    conf=tel_config,
    msg="global-plucking --- analysis_phillipscurve_urate_nairu_usa: COMPLETED",
)
