...
# POLS
# Without REER
eqn = "corecpi ~ 1 + urate * urate_gap * urate_gap_sq + expcpi + corecpi_lag1"
mod_pols, res_pols, params_table_pols, joint_teststats_pols, reg_det_pols = reg_ols(
    df=df, eqn=eqn
)
file_name = path_output + "phillipscurve_urate_ugap_nonlinear_reducedsample_params_pols"
...
# With REER
eqn = "corecpi ~ 1 + urate * urate_gap * urate_gap_sq + expcpi + corecpi_lag1 + reer"
(
    mod_pols_reer,
    res_pols_reer,
...
file_name = path_output + "phillipscurve_urate_ugap_nonlinear_reducedsample_params_pols_reer"
list_file_names += [file_name]
...
file_name = path_output + "phillipscurve_urate_ugap_nonlinear_reducedsample_params_fe"
list_file_names += [file_name]
...
file_name = path_output + "phillipscurve_urate_ugap_nonlinear_reducedsample_params_fe_reer"
list_file_names += [file_name]
...
file_name_pdf = path_output + "phillipscurve_urate_ugap_nonlinear_reducedsample_params"
...
telsendmsg(
    conf=tel_config,
    msg="global-plucking --- analysis_phillipscurve_urate_ugap_nonlinear_reducedsample: COMPLETED",
)
