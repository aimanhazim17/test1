...
file_name = path_output + "macrodynamics_urate_threshold_lp_irf_reducedsample"
...
fig_irf = lp.ThresholdIRFPlot(
    ...
    maintitle="Local Projections Model: Impulse Response Functions (Excluding MYS, IND, BRA); Red = U-Rate is At its Floor",
    show_fig=False,
    save_pic=False,
    out_path="",
    out_name="",
...
# X --- Notify
telsendmsg(
    conf=tel_config, msg="global-plucking --- analysis_macrodynamics_urate_threshold_reducedsample: COMPLETED"
)
