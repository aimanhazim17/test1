...
file_name = path_output + "analysis_okun_ugap_reducedsample_params_pols"
list_file_names += [file_name]
chart_title = "Pooled OLS (Excluding MYS, IND, BRA)"
fig = heatmap(
...
file_name = path_output + "analysis_okun_ugap_reducedsample_params_fe"
list_file_names += [file_name]
chart_title = "FE (Excluding MYS, IND, BRA)"
fig = heatmap(
...
file_name_pdf = path_output + "analysis_okun_ugap_reducedsample_params"
...
# X --- Notify
telsendmsg(
    conf=tel_config, msg="global-plucking --- analysis_okun_ugap_reducedsample: COMPLETED"
)
