...
file_name_pdf = path_output + "phillipscurve_urate_base_usa_params"
...
telsendmsg(
    conf=tel_config,
    msg="global-plucking --- analysis_phillipscurve_urate_base_usa: COMPLETED",
)
