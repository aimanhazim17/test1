...
file_name = path_output + "phillipscurve_urate_ugap_exusa_reducedsample_params_gmmiv"
list_file_names += [file_name]
...
file_name = (
    path_output + "phillipscurve_urate_ugap_exusa_reducedsample_params_gmmiv_reer"
)
list_file_names += [file_name]
...
if not skip_twfe:
    ...
    file_name = path_output + "phillipscurve_urate_ugap_exusa_reducedsample_params_twfe"
    list_file_names += [file_name]
    ...
    file_name = (
        path_output + "phillipscurve_urate_ugap_exusa_reducedsample_params_twfe_reer"
    )
    list_file_names += [file_name]
...
file_name = path_output + "phillipscurve_urate_ugap_exusa_reducedsample_params_re"
list_file_names += [file_name]
...
file_name = path_output + "phillipscurve_urate_ugap_exusa_reducedsample_params_re_reer"
list_file_names += [file_name]
...
file_name = path_output + "phillipscurve_urate_ugap_exusa_reducedsample_loglik"
list_file_names += [file_name]
...
file_name_pdf = path_output + "phillipscurve_urate_ugap_exusa_reducedsample_params"
...
telsendmsg(
    conf=tel_config,
    msg="global-plucking --- analysis_phillipscurve_urate_ugap_exusa_reducedsample_reducedsample: COMPLETED",
)
