...
file_name = path_output + "phillipscurve_urate_base_reducedsample_params_gmmiv"
list_file_names += [file_name]
...
file_name = path_output + "phillipscurve_urate_base_reducedsample_params_gmmiv_reer"
list_file_names += [file_name]
...
file_name = path_output + "phillipscurve_urate_base_reducedsample_params_twfe"
list_file_names += [file_name]
...
file_name = path_output + "phillipscurve_urate_base_reducedsample_params_twfe_reer"
list_file_names += [file_name]
...
file_name = path_output + "phillipscurve_urate_base_reducedsample_params_re"
list_file_names += [file_name]
...
file_name = path_output + "phillipscurve_urate_base_reducedsample_params_re_reer"
list_file_names += [file_name]
...
file_name = path_output + "phillipscurve_urate_base_reducedsample_loglik"
list_file_names += [file_name]
...
file_name_pdf = path_output + "phillipscurve_urate_base_reducedsample_params"
