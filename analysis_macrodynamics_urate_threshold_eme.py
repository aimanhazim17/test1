...
# III --- Analysis
# Setup
endog_base = ["expcpi", "privdebt", "urate", "corecpi", "stir", "reer"]
...
file_name = path_output + "macrodynamics_urate_threshold_lp_irf_eme"
...
# X --- Notify
telsendmsg(
    conf=tel_config, msg="global-plucking --- analysis_macrodynamics_urate_threshold_eme: COMPLETED"
)
