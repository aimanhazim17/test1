...
mod_gmmiv, res_gmmiv, params_table_gmmiv = gmmiv_reg(
    df=df,
    eqn="corecpi urate_gap_ratio expcpi L(1:4).corecpi | "
    + "endo(corecpi) pred(urate_gap_ratio expcpi) | " 
    + "hqic collapse",
    i_col="country",
    t_col="time",
)
file_name = path_output + "phillipscurve_ugap_params_gmmiv"
list_file_names += [file_name]
...
mod_gmmiv_reer, res_gmmiv_reer, params_table_gmmiv_reer = gmmiv_reg(
    df=df,
    eqn="corecpi urate_gap_ratio expcpi reer L(1:4).corecpi | "
    + "endo(corecpi) pred(urate_gap_ratio expcpi reer) | " 
    + "hqic collapse",
    i_col="country",
    t_col="time",
)
file_name = path_output + "phillipscurve_ugap_params_gmmiv_reer"
list_file_names += [file_name]
