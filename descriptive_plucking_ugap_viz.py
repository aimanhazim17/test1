...
# %%
# III --- Plot
for country_groups, snakecase_group_name, nice_group_name, n_rows, n_cols in zip(
    nested_list_country_groups,
    ...
    fig_urate_and_ceiling.write_image(path_output + "urate_and_ceiling_" + snakecase_group_name + ".png")
    telsendimg(
        conf=tel_config,
        path=path_output + "urate_and_ceiling_" + snakecase_group_name + ".png",
        cap="urate_and_ceiling_" + snakecase_group_name
    )
