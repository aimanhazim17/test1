...
file_name = path_output + "phillipscurve_urate_headlinecpi_params_pols"
...
file_name = path_output + "phillipscurve_urate_headlinecpi_params_pols_reer"
list_file_names += [file_name]
...
file_name = path_output + "phillipscurve_urate_headlinecpi_params_fe"
list_file_names += [file_name]
...
file_name = path_output + "phillipscurve_urate_headlinecpi_params_fe_reer"
list_file_names += [file_name]
...
mod_gmmiv, res_gmmiv, params_table_gmmiv = gmmiv_reg(
    df=df,
    eqn="cpi urate urate_gap_is_zero urate_int_urate_gap_is_zero expcpi L1.cpi | "
    + "endo(cpi) pred(urate urate_gap_is_zero urate_int_urate_gap_is_zero expcpi) | " 
    + "hqic collapse",
    i_col="country",
    t_col="time",
)
file_name = path_output + "phillipscurve_urate_headlinecpi_params_gmmiv"
list_file_names += [file_name]
...
mod_gmmiv_reer, res_gmmiv_reer, params_table_gmmiv_reer = gmmiv_reg(
    df=df,
    eqn="cpi urate urate_gap_is_zero urate_int_urate_gap_is_zero expcpi reer L1.cpi | "
    + "endo(cpi) pred(urate urate_gap_is_zero urate_int_urate_gap_is_zero expcpi reer) | " 
    + "hqic collapse",
    i_col="country",
    t_col="time",
)
file_name = path_output + "phillipscurve_urate_headlinecpi_params_gmmiv_reer"
list_file_names += [file_name]
...
file_name = path_output + "phillipscurve_urate_headlinecpi_params_twfe"
list_file_names += [file_name]
...
file_name = path_output + "phillipscurve_urate_headlinecpi_params_twfe_reer"
list_file_names += [file_name]
...
file_name = path_output + "phillipscurve_urate_headlinecpi_params_re"
list_file_names += [file_name]
...
file_name = path_output + "phillipscurve_urate_headlinecpi_params_re_reer"
list_file_names += [file_name]
...
file_name_pdf = path_output + "phillipscurve_urate_headlinecpi_params"
...
# X --- Notify
telsendmsg(
    conf=tel_config, msg="global-plucking --- analysis_phillipscurve_urate_headlinecpi: COMPLETED"
)
